	...
	Vue.component('challenge', {
		...
		template: `
				<div v-if="tmp[layer].challenges && tmp[layer].challenges[data]!== undefined && tmp[layer].challenges[data].unlocked && !(options.hideChallenges && maxedChallenge(layer, [data]) && !inChallenge(layer, [data]))"
					...
					<span v-if="layers[layer].challenges[data].display" v-html="run(layers[layer].challenges[data].display, layers[layer].challenges[data])"></span>
					<span v-else>
								<span v-if="layers[layer].challenges[data].display" v-html="run(layers[layer].challenges[data].fullDisplay, layers[layer].challenges[data])"></span>
